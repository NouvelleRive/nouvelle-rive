  ...
  try {
    ...
    const productions = dates.map((date, i) => {
      ...
      return {
        ...
        vignetteOptions: Array.isArray(data.vignetteOptions) ? data.vignetteOptions : [],
        vignetteOffsetY: typeof data.vignetteOffsetY === 'number' ? data.vignetteOffsetY : 50,
...
export async function POST(req: NextRequest) {
  try {
    ...
    const payload = {
      ...
      vignetteOptions: Array.isArray(body.vignetteOptions) ? body.vignetteOptions : [],
      vignetteOffsetY: typeof body.vignetteOffsetY === 'number' ? body.vignetteOffsetY : 50,
