...
const CONTRAT_ARTICLES = [
  ...
  { n: 5, t: 'Commission et reversement', c: "60 % reversés au Déposant en cas de règlement par virement — 70 % en cas de règlement en avoir boutique. Le reversement intervient dans les 30 jours suivant la vente. Le Déposant fera son affaire de ses obligations fiscales." },
