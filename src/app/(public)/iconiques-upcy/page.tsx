  ...
  useEffect(() => {
    ...
    async function fetchIconiques() {
      try {
        ...
        console.error('Erreur fetch iconiques upcy:', err)
      } finally {
  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="px-6 py-20" style={{ fontFamily: fontHelvetica }}>
        ...
        >
          {lang === 'en' ? <>OUR FAVORITE<br />UPCYCLED PIECES</> : <>NOS PIÈCES UPCY<br />FAVORITES</>}
        </h1>
      </div>
