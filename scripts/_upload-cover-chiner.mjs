...
const buf=readFileSync('/private/tmp/claude-501/-Users-salomekassabi-Desktop-nouvelle-rive/574b8f36-fb06-47a8-8294-2f5892431202/scratchpad/chiner_rot.jpg')
...
for(const a of articles) if(a.slug==='chiner-vintage-marais'){ a.cover=url; console.log('✓ couverture màj') }
