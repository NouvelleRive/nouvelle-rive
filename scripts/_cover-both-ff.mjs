...
const url='https://nouvellerive.b-cdn.net/journal/detester-fast-fashion.jpg'
for(const a of articles) if(a.slug==='vintage-plutot-que-fast-fashion'){ a.cover=url; console.log('✓ cover màj:',a.slug) }
