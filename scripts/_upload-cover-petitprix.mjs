...
const path='journal/vintage-petit-prix.jpg'
const buf=readFileSync('/private/tmp/claude-501/-Users-salomekassabi-Desktop-nouvelle-rive/574b8f36-fb06-47a8-8294-2f5892431202/scratchpad/petitprix.jpg')
...
for(const a of articles) if(a.slug==='vintage-luxe-petit-prix'){ a.cover=url; console.log('✓ cover màj') }
