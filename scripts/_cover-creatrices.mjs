...
const path='journal/jeunes-creatrices.jpg'
const buf=readFileSync('/private/tmp/claude-501/-Users-salomekassabi-Desktop-nouvelle-rive/574b8f36-fb06-47a8-8294-2f5892431202/scratchpad/img0421.jpg')
...
for(const a of articles) if(a.slug==='pourquoi-soutenir-jeunes-creatrices'){ a.cover=url; console.log('✓ cover màj') }
