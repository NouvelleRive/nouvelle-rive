...
console.log(`Encodé: ${inSize}MB → ${outSize}MB`)
...
const next = [...cur, NEW_URL]
await ref.update({ videos: next })
console.log(`✅ bagues-voiture videos mis à jour (${next.length})`)
process.exit(0)
