// v2 — même voix / mêmes sous-titres que la v1, sur la base des nouvelles couleurs.
...
const BASE = join(OUTDIR, 'infinite-strass-chronique-v2-2rangs.mp4')
// Même son que la v1 (bande voix extraite de voix-strass-chronique.mp4).
const AUDIO = join(OUTDIR, 'data', 'strass-son.m4a')
const OUT = join(OUTDIR, 'voix-strass-chronique-v2.mp4')
